...
const querySchema = z.object({ page: z.coerce.number().int().min(1).default(1), pageSize: z.coerce.number().int().min(1).max(100).default(20), roleId: z.string().optional(), gradeId: z.string().optional(), department: z.string().optional() });
@ApiTags('employees')
@ApiBearerAuth()
@ApiErrors()
