...
export const employeeListItemSchema = z.object({
  ...
  tenureMonths: z.number().int().nonnegative(), workFormat: z.enum(['office', 'hybrid', 'remote','unknown']), preferredLanguage: z.enum(['en', 'ru', 'kk']),
  importAssumptions:z.array(z.unknown()).optional(),
