...
Обновлено после исправлений и объединения семиязычного интерфейса 23.09.2026. Проверка объединённой версии: [merge-verification.md](merge-verification.md). Результаты исправлений и живого OpenAI до объединения: [fixes-verification.md](fixes-verification.md). Предыдущие результаты в `verification.md` относятся к состоянию до этого аудита.
